...
namespace MyProjectTemplate.API.Services {
    public class Logger {
        ...
        public void Log(Guid subId, Guid deviceId, string level, string message, string performedBy = "[SYST]") {
            var log = new SubLog {
                SubId = subId,
                Level = level,
                Message = message,
        ...
        public void Warning(Guid deviceId, string msg) => Log(Guid.Parse("11111111-1111-1111-1111-111111111111"), deviceId, "[WARN]", msg);
        public void Danger(Guid deviceId, string msg) => Log(Guid.Parse("11111111-1111-1111-1111-111111111111"), deviceId, "[DNGR]", msg);
    }
}